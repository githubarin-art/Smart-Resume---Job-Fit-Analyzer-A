    ...
    return (
        <div className={`bg-gradient-to-b ${bgGradient} border-b border-[var(--color-neutral-200)] pb-12 pt-8 px-6 relative overflow-hidden`}>
            ...
            <div className="max-w-5xl mx-auto grid md:grid-cols-[200px_1fr] gap-8 items-center relative z-10">
                {/* Chart */}
                <div className="relative w-40 h-40 mx-auto flex items-center justify-center transform hover:scale-105 transition-transform duration-500">
                        ...
                        <div className="bg-gradient-to-br from-[var(--color-neutral-900)] to-[var(--color-neutral-800)] rounded-[24px] p-8 text-center text-white space-y-6 shadow-xl">
                            ...
                            <div className="flex flex-col gap-3">
                                <button
                                    ...
                                    className="btn bg-white text-[var(--color-neutral-900)] hover:bg-[var(--color-neutral-100)] border-0 w-full justify-center font-semibold"
                                >
                                ...
                                <button
                                    onClick={handleShare}
                                    className="btn border border-white/20 hover:border-white/40 text-white bg-white/10 hover:bg-white/20 w-full justify-center"
                                >
                                ...
                                <button
                                    onClick={onStartOver}
                                    className="btn border border-white/20 hover:border-white/40 text-white bg-transparent w-full justify-center"
                                >
